/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function (a, b) {
    ...
    function s(a) {
        var b = a.length,
            c = o.type(a);
        return "function" !== c && !o.isWindow(a) && (!(1 !== a.nodeType || !b) || ("array" === c || 0 === b || "number" == typeof b && b > 0 && b - 1 in a))
    }
    o.fn = o.prototype = {
        jquery: n,
        constructor: o,
        ...
        for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == typeof g || o.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++)
            if (null != (a = arguments[h]))
                for (b in a) c = g[b], g !== (d = a[b]) && (j && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? (e = !1, f = c && o.isArray(c) ? c : []) : f = c && o.isPlainObject(c) ? c : {}, g[b] = o.extend(j, f, d)) : void 0 !== d && (g[b] = d));
        return g
    }, o.extend({
        ...
        each: function (a, b, c) {
            ...
            if (c) {
                if (g)
                    for (; f > e && !1 !== (d = b.apply(a[e], c)); e++);
                else
                    for (e in a)
                        if (!1 === (d = b.apply(a[e], c))) break
            } else if (g)
                for (; f > e && !1 !== (d = b.call(a[e], e, a[e])); e++);
            else
                for (e in a)
                    if (!1 === (d = b.call(a[e], e, a[e]))) break;
            return a
        },
        trim: function (a) {
        ...
        grep: function (a, b, c) {
            for (var d, e = [], f = 0, g = a.length, h = !c; g > f; f++)(d = !b(a[f], f)) !== h && e.push(a[f]);
            return e
        },
        map: function (a, b, c) {
            var d, f = 0,
        ...
        proxy: function (a, b) {
            ...
            }).guid = a.guid = a.guid || o.guid++, f) : void 0
        },
        now: Date.now,
        support: l
    ...
    var t = function (a) {
        ...
        function xb(a, b, e, f) {
            ...
            if (!f && 1 === m.length) {
                if ((i = m[0] = m[0].slice(0)).length > 2 && "ID" === (j = i[0]).type && c.getById && 9 === b.nodeType && n && d.relative[i[1].type]) {
    ...
    o.filter = function (a, b, c) {
        ...
        find: function (a) {
            ...
            return (d = this.pushStack(c > 1 ? o.unique(d) : d)).selector = this.selector ? this.selector + " " + a : a, d
        },
        filter: function (a) {
    ...
    (o.fn.init = function (a, b) {
        ...
        if ("string" == typeof a) {
            ...
            return (d = m.getElementById(c[2])) && d.parentNode && (this.length = 1, this[0] = d), this.context = m, this.selector = a, this
        }
        return a.nodeType ? (this.context = this[0] = a, this.length = 1, this) : o.isFunction(a) ? void 0 !== y.ready ? y.ready(a) : a(o) : (void 0 !== a.selector && (this.selector = a.selector, this.context = a.context), o.makeArray(a, this))
    }).prototype = o.fn, y = o(m);
    ...
    o.Callbacks = function (a) {
        ...
        ready: function (a) {
            (!0 === a ? --o.readyWait : o.isReady) || (o.isReady = !0, !0 !== a && --o.readyWait > 0 || (H.resolveWith(m, [o]), o.fn.trigger && o(m).trigger("ready").off("ready")))
        }
    ...
    var J = o.access = function (a, b, c, d, e, f, g) {
        var h = 0,
            ...
            j = null == c;
        if ("object" === o.type(c))
            for (h in e = !0, c) o.access(a, b, h, c[h], !0, f, g);
    ...
    o.acceptData = function (a) {
        ...
        access: function (a, b, c) {
            var d;
            return void 0 === b || b && "string" == typeof b && void 0 === c ? void 0 !== (d = this.get(a, b)) ? d : this.get(a, o.camelCase(b)) : (this.set(a, b, c), void 0 !== c ? c : b)
        },
        remove: function (a, b) {
            ...
            if (void 0 === b) this.cache[f] = {};
                ...
                o.isArray(b) ? d = b.concat(b.map(o.camelCase)) : (e = o.camelCase(b), b in g ? d = [b, e] : d = (d = e) in g ? [d] : d.match(E) || []), c = d.length;
                for (; c--;) delete g[d[c]]
            }
        },
        hasData: function (a) {
    ...
    function P(a, b, c) {
        ...
        if (void 0 === c && 1 === a.nodeType)
            if (d = "data-" + b.replace(O, "-$1").toLowerCase(), "string" == typeof (c = a.getAttribute(d))) {
                try {
                    c = "true" === c || "false" !== c && ("null" === c ? null : +c + "" === c ? +c : N.test(c) ? o.parseJSON(c) : c)
                } catch (e) {}
                M.set(a, b, c)
            } else c = void 0;
        return c
        ...
        data: function (a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = M.get(f), 1 === f.nodeType && !L.get(f, "hasDataAttrs"))) {
                    for (c = g.length; c--;) 0 === (d = g[c].name).indexOf("data-") && (d = o.camelCase(d.slice(5)), P(f, d, e[d]));
    ...
    var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        T = /^(?:checkbox|radio)$/i;
    ! function () {
        var a, b = m.createDocumentFragment().appendChild(m.createElement("div"));
    ...
    o.event = {
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r)
                for (c.handler && (c = (f = c).handler, e = f.selector), c.guid || (c.guid = o.guid++), (i = r.events) || (i = r.events = {}), (g = r.handle) || (g = r.handle = function (b) {
                        return typeof o !== U && o.event.triggered !== b.type ? o.event.dispatch.apply(a, arguments) : void 0
                    }), j = (b = (b || "").match(E) || [""]).length; j--;) n = q = (h = Y.exec(b[j]) || [])[1], p = (h[2] || "").split(".").sort(), n && (l = o.event.special[n] || {}, n = (e ? l.delegateType : l.bindType) || n, l = o.event.special[n] || {}, k = o.extend({
                    type: n,
                    origType: q,
                    data: d,
                    handler: c,
                    ...
                    namespace: p.join(".")
                }, f), (m = i[n]) || ((m = i[n] = []).delegateCount = 0, l.setup && !1 !== l.setup.call(a, d, p, g) || a.addEventListener && a.addEventListener(n, g, !1)), l.add && (l.add.call(a, k), k.handler.guid || (k.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, k) : m.push(k), o.event.global[n] = !0)
        },
        remove: function (a, b, c, d, e) {
            var f, g, h, i, j, k, l, m, n, p, q, r = L.hasData(a) && L.get(a);
            if (r && (i = r.events)) {
                for (j = (b = (b || "").match(E) || [""]).length; j--;)
                    if (n = q = (h = Y.exec(b[j]) || [])[1], p = (h[2] || "").split(".").sort(), n) {
                        for (l = o.event.special[n] || {}, m = i[n = (d ? l.delegateType : l.bindType) || n] || [], h = h[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), g = f = m.length; f--;) k = m[f], !e && q !== k.origType || c && c.guid !== k.guid || h && !h.test(k.namespace) || d && d !== k.selector && ("**" !== d || !k.selector) || (m.splice(f, 1), k.selector && m.delegateCount--, l.remove && l.remove.call(a, k));
                        g && !m.length && (l.teardown && !1 !== l.teardown.call(a, p, r.handle) || o.removeEvent(a, n, r.handle), delete i[n])
                    } else
        ...
        trigger: function (b, c, d, e) {
            ...
            if (g = h = d = d || m, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + o.event.triggered) && (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k = q.indexOf(":") < 0 && "on" + q, (b = b[o.expando] ? b : new o.Event(q, "object" == typeof b && b)).isTrigger = e ? 2 : 3, b.namespace = r.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : o.makeArray(c, [b]), n = o.event.special[q] || {}, e || !n.trigger || !1 !== n.trigger.apply(d, c))) {
                ...
                for (f = 0;
                    (g = p[f++]) && !b.isPropagationStopped();) b.type = f > 1 ? i : n.bindType || q, (l = (L.get(g, "events") || {})[b.type] && L.get(g, "handle")) && l.apply(g, c), (l = k && g[k]) && l.apply && o.acceptData(g) && (b.result = l.apply(g, c), !1 === b.result && b.preventDefault());
                return b.type = q, e || b.isDefaultPrevented() || n._default && !1 !== n._default.apply(p.pop(), c) || !o.acceptData(d) || k && o.isFunction(d[q]) && !o.isWindow(d) && ((h = d[k]) && (d[k] = null), o.event.triggered = q, d[q](), o.event.triggered = void 0, h && (d[k] = h)), b.result
            }
        },
        dispatch: function (a) {
            a = o.event.fix(a);
            ...
            if (i[0] = a, a.delegateTarget = this, !k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
                for (h = o.event.handlers.call(this, a, j), b = 0;
                    ...
                    for (a.currentTarget = f.elem, c = 0;
                        (g = f.handlers[c++]) && !a.isImmediatePropagationStopped();)(!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, void 0 !== (e = ((o.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)) && !1 === (a.result = e) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (h && i.nodeType && (!a.button || "click" !== a.type))
                for (; i !== this; i = i.parentNode || this)
                    if (!0 !== i.disabled || "click" !== a.type) {
                        for (d = [], c = 0; h > c; c++) void 0 === d[e = (f = b[c]).selector + " "] && (d[e] = f.needsContext ? o(e, this).index(i) >= 0 : o.find(e, this, null, [i]).length), d[e] && d.push(f);
                        d.length && g.push({
                            elem: i,
                            handlers: d
                        })
        ...
        mouseHooks: {
            ...
            filter: function (a, b) {
                ...
                return null == a.pageX && null != b.clientX && (d = (c = a.target.ownerDocument || m).documentElement, e = c.body, a.pageX = b.clientX + (d && d.scrollLeft || e && e.scrollLeft || 0) - (d && d.clientLeft || e && e.clientLeft || 0), a.pageY = b.clientY + (d && d.scrollTop || e && e.scrollTop || 0) - (d && d.clientTop || e && e.clientTop || 0)), a.which || void 0 === f || (a.which = 1 & f ? 1 : 2 & f ? 3 : 4 & f ? 2 : 0), a
            }
        },
        fix: function (a) {
            ...
            var b, c, d, e = a.type,
                f = a,
                g = this.fixHooks[e];
            for (g || (this.fixHooks[e] = g = W.test(e) ? this.mouseHooks : V.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(g.props) : this.props, a = new o.Event(f), b = d.length; b--;) a[c = d[b]] = f[c];
        ...
        on: function (a, b, c, d, e) {
            ...
            }).guid = f.guid || (f.guid = o.guid++)), this.each((function () {
    ...
    ib.optgroup = ib.option, ib.tbody = ib.tfoot = ib.colgroup = ib.caption = ib.thead, ib.th = ib.td, o.extend({
        clone: function (a, b, c) {
            ...
            if (!(l.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || o.isXMLDoc(a)))
                for (g = ob(h), d = 0, e = (f = ob(a)).length; e > d; d++) pb(f[d], g[d]);
            if (b)
                if (c)
                    for (f = f || ob(a), g = g || ob(h), d = 0, e = f.length; e > d; d++) nb(f[d], g[d]);
                else nb(a, h);
            return (g = ob(h, "script")).length > 0 && mb(g, !i && ob(a, "script")), h
        },
        buildFragment: function (a, b, c, d) {
            for (var e, f, g, h, i, j, k = b.createDocumentFragment(), l = [], m = 0, n = a.length; n > m; m++)
                ...
                o.merge(l, f.childNodes), (f = k.firstChild).textContent = ""
        ...
        cleanData: function (a) {
            for (var b, c, d, e, f, g, h = o.event.special, i = 0; void 0 !== (c = a[i]); i++) {
                if (o.acceptData(c) && ((f = c[L.expando]) && (b = L.cache[f]))) {
                    if ((d = Object.keys(b.events || {})).length)
        ...
        html: function (a) {
            return J(this, (function (a) {
                ...
                if ("string" == typeof a && !db.test(a) && !ib[(bb.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(ab, "<$1></$2>");
                    try {
                        for (; d > c; c++) 1 === (b = this[c] || {}).nodeType && (o.cleanData(ob(b, !1)), b.innerHTML = a);
                        b = 0
                    } catch (e) {}
                }
        ...
        domManip: function (a, b) {
            ...
            if (k && (d = (c = o.buildFragment(a, this[0].ownerDocument, !1, this)).firstChild, 1 === c.childNodes.length && (c = d), d)) {
                for (g = (f = o.map(ob(c, "script"), kb)).length; k > j; j++) h = c, j !== n && (h = o.clone(h, !0, !0), g && o.merge(f, ob(h, "script"))), b.call(this[j], h, j);
                if (g)
    ...
    function tb(a) {
        var b = m,
            c = rb[a];
        return c || ("none" !== (c = sb(a, b)) && c || ((b = (qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement))[0].contentDocument).write(), b.close(), c = sb(a, b), qb.detach()), rb[a] = c), c
    }
    var ub = /^margin/,
    ...
    function xb(a, b, c) {
        ...
        return (c = c || wb(a)) && (g = c.getPropertyValue(b) || c[b]), c && ("" !== g || o.contains(a.ownerDocument, a) || (g = o.style(a, b)), vb.test(g) && ub.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), void 0 !== g ? g + "" : g
    }
    ...
    function yb(a, b) {
        ...
        g.style.backgroundClip = "content-box", g.cloneNode(!0).style.backgroundClip = "", l.clearCloneStyle = "content-box" === g.style.backgroundClip, f.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", f.appendChild(g), a.getComputedStyle && o.extend(l, {
    ...
    function Ib(a, b, c) {
        ...
        if (0 >= e || null == e) {
            if ((0 > (e = xb(a, b, f)) || null == e) && (e = a.style[b]), vb.test(e)) return e;
    ...
    function Jb(a, b) {
        for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)(d = a[g]).style && (f[g] = L.get(d, "olddisplay"), c = d.style.display, b ? (f[g] || "none" !== c || (d.style.display = ""), "" === d.style.display && S(d) && (f[g] = L.access(d, "olddisplay", tb(d.nodeName)))) : f[g] || (e = S(d), (c && "none" !== c || !e) && L.set(d, "olddisplay", e ? c : o.css(d, "display"))));
    ...
    o.extend({
        ...
        css: function (a, b, c, d) {
            var e, f, g, h = o.camelCase(b);
            return b = o.cssProps[h] || (o.cssProps[h] = Fb(a.style, h)), (g = o.cssHooks[b] || o.cssHooks[h]) && "get" in g && (e = g.get(a, !0, c)), void 0 === e && (e = xb(a, b, d)), "normal" === e && b in Db && (e = Db[b]), "" === c || c ? (f = parseFloat(e), !0 === c || o.isNumeric(f) ? f || 0 : e) : e
        }
        ...
        _default: {
            get: function (a) {
                var b;
                return null == a.elem[a.prop] || a.elem.style && null != a.elem.style[a.prop] ? (b = o.css(a.elem, a.prop, "")) && "auto" !== b ? b : 0 : a.elem[a.prop]
            },
            set: function (a) {
    ...
    function Vb(a, b, c) {
        var d, e, f, g, h, i, j, k = this,
            ...
            n = a.nodeType && S(a),
            p = L.get(a, "fxshow");
        for (d in c.queue || (null == (h = o._queueHooks(a, "fx")).unqueued && (h.unqueued = 0, i = h.empty.fire, h.empty.fire = function () {
                h.unqueued || i()
            }), h.unqueued++, k.always((function () {
                k.always((function () {
                    h.unqueued--, o.queue(a, "fx").length || h.empty.fire()
                }))
            }))), 1 === a.nodeType && ("height" in b || "width" in b) && (c.overflow = [m.overflow, m.overflowX, m.overflowY], "none" === (j = o.css(a, "display")) && (j = tb(a.nodeName)), "inline" === j && "none" === o.css(a, "float") && (m.display = "inline-block")), c.overflow && (m.overflow = "hidden", k.always((function () {
            ...
            for (d in p ? "hidden" in p && (n = p.hidden) : p = L.access(a, "fxshow", {}), f && (p.hidden = !n), n ? o(a).show() : k.done((function () {
                    o(a).hide()
                })), k.done((function () {
                    var b;
                    for (b in L.remove(a, "fxshow"), l) o.style(a, b, l[b])
                })), l) g = Ub(n ? p[d] : 0, d, k), d in p || (p[d] = g.start, n && (g.end = g.start, g.start = "width" === d || "height" === d ? 1 : 0))
    }

    function Wb(a, b) {
        var c, d, e, f, g;
        for (c in a)
            if (e = b[d = o.camelCase(c)], f = a[c], o.isArray(f) && (e = f[1], f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), (g = o.cssHooks[d]) && "expand" in g)
    ...
    function Xb(a, b, c) {
        var d, e, f = 0,
            ...
            i = function () {
                if (e) return !1;
                for (var b = Lb || Sb(), c = Math.max(0, j.startTime + j.duration - b), d, f = 1 - (c / j.duration || 0), g = 0, i = j.tweens.length; i > g; g++) j.tweens[g].run(f);
    ...
    o.Animation = o.extend(Xb, {
            ...
            return d.duration = o.fx.off ? 0 : "number" == typeof d.duration ? d.duration : d.duration in o.fx.speeds ? o.fx.speeds[d.duration] : o.fx.speeds._default, (null == d.queue || !0 === d.queue) && (d.queue = "fx"), d.old = d.complete, d.complete = function () {
            ...
            var a, b = 0,
                c = o.timers;
            for (Lb = o.now(); b < c.length; b++)(a = c[b])() || c[b] !== a || c.splice(b--, 1);
            ...
            return a = o.fx && o.fx.speeds[a] || a, b = b || "fx", this.queue(b, (function (b, c) {
        ...
        function () {
            ...
            a.type = "checkbox", l.checkOn = "" !== a.value, l.optSelected = c.selected, b.disabled = !0, l.optDisabled = !c.disabled, (a = m.createElement("input")).value = "t", a.type = "radio", l.radioValue = "t" === a.value
        }();
    ...
    o.fn.extend({
        ...
        attr: function (a, b, c) {
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f) return typeof a.getAttribute === U ? o.prop(a, b, c) : (1 === f && o.isXMLDoc(a) || (b = b.toLowerCase(), d = o.attrHooks[b] || (o.expr.match.bool.test(b) ? Zb : Yb)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : null == (e = o.find.attr(a, b)) ? void 0 : e : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void o.removeAttr(a, b))
        },
        ...
        set: function (a, b, c) {
            return !1 === b ? o.removeAttr(a, c) : a.setAttribute(c, c), c
        }
    ...
    o.fn.extend({
        ...
        prop: function (a, b, c) {
            ...
            if (a && 3 !== g && 8 !== g && 2 !== g) return (f = 1 !== g || !o.isXMLDoc(a)) && (b = o.propFix[b] || b, e = o.propHooks[b]), void 0 !== c ? e && "set" in e && void 0 !== (d = e.set(a, c, b)) ? d : a[b] = c : e && "get" in e && null !== (d = e.get(a, b)) ? d : a[b]
        },
        propHooks: {
            tabIndex: {
                get: function (a) {
    ...
    o.fn.extend({
        val: function (a) {
            ...
            return arguments.length ? (d = o.isFunction(a), this.each((function (c) {
                var e;
                1 === this.nodeType && (null == (e = d ? a.call(this, c, o(this).val()) : a) ? e = "" : "number" == typeof e ? e += "" : o.isArray(e) && (e = o.map(e, (function (a) {
                    return null == a ? "" : a + ""
                }))), (b = o.valHooks[this.type] || o.valHooks[this.nodeName.toLowerCase()]) && "set" in b && void 0 !== b.set(this, e, "value") || (this.value = e))
            }))) : e ? (b = o.valHooks[e.type] || o.valHooks[e.nodeName.toLowerCase()]) && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : "string" == typeof (c = e.value) ? c.replace(bc, "") : null == c ? "" : c : void 0
        }
    }), o.extend({
        valHooks: {
            select: {
                get: function (a) {
                    for (var b, c, d = a.options, e = a.selectedIndex, f = "select-one" === a.type || 0 > e, g = f ? null : [], h = f ? e + 1 : d.length, i = 0 > e ? h : f ? e : 0; h > i; i++)
                        if (!(!(c = d[i]).selected && i !== e || (l.optDisabled ? c.disabled : null !== c.getAttribute("disabled")) || c.parentNode.disabled && o.nodeName(c.parentNode, "optgroup"))) {
                            if (b = o(c).val(), f) return b;
                            g.push(b)
                        } return g
                },
                set: function (a, b) {
                    for (var c, d, e = a.options, f = o.makeArray(b), g = e.length; g--;)((d = e[g]).selected = o.inArray(o(d).val(), f) >= 0) && (c = !0);
    ...
    o.parseJSON = function (a) {
        ...
        try {
            b = (c = new DOMParser).parseFromString(a, "text/xml")
        } catch (d) {
            b = void 0
        }
    ...
    ec = mc.exec(fc.toLowerCase()) || [], o.extend({
        ...
        ajax: function (a, b) {
            ...
            for (j in (i = k.global) && 0 == o.active++ && o.event.trigger("ajaxStart"), k.type = k.type.toUpperCase(), k.hasContent = !kc.test(k.type), d = k.url, k.hasContent || (k.data && (d = k.url += (dc.test(d) ? "&" : "?") + k.data, delete k.data), !1 === k.cache && (k.url = hc.test(d) ? d.replace(hc, "$1_=" + cc++) : d + (dc.test(d) ? "&" : "?") + "_=" + cc++)), k.ifModified && (o.lastModified[d] && v.setRequestHeader("If-Modified-Since", o.lastModified[d]), o.etag[d] && v.setRequestHeader("If-None-Match", o.etag[d])), (k.data && k.hasContent && !1 !== k.contentType || b.contentType) && v.setRequestHeader("Content-Type", k.contentType), v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + pc + "; q=0.01" : "") : k.accepts["*"]), k.headers) v.setRequestHeader(j, k.headers[j]);
    ...
    o.ajaxSetup({
        ...
        return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = o.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Hc, "$1" + e) : !1 !== b.jsonp && (b.url += (dc.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
    ...
    o.offset = {
        setOffset: function (a, b, c) {
            var d, e, f, g, h, i, j, k = o.css(a, "position"),
                l = o(a),
                m = {};
            "static" === k && (a.style.position = "relative"), h = l.offset(), f = o.css(a, "top"), i = o.css(a, "left"), (j = ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1) ? (g = (d = l.position()).top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), o.isFunction(b) && (b = b.call(a, c, h)), null != b.top && (m.top = b.top - h.top + g), null != b.left && (m.left = b.left - h.left + e), "using" in b ? b.using.call(a, m) : l.css(m)
        }
    }, o.fn.extend({
        offset: function (a) {
            ...
            var b, c, d = this[0],
                ...
                f = d && d.ownerDocument;
            return f ? (b = f.documentElement, o.contains(b, d) ? (typeof d.getBoundingClientRect !== U && (e = d.getBoundingClientRect()), c = Kc(f), {
